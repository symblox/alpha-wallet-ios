    ...
    func transactionURL(for ID: String) -> (url: URL, name: String?)? {
        ...
        let urlString: String? = {
            ...
            case .custom, .callisto:
                return .none
            case .main, .kovan, .ropsten, .rinkeby, .sokol, .classic, .xDai, .goerli, .artis_sigma1, .artis_tau1, .binance_smart_chain, .binance_smart_chain_testnet, .velas, .velastestnet, .velaschina:
